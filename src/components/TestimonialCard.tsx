...
export function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <figure className="flex h-full flex-col rounded-2xl border border-gold-500/40 bg-white/[0.04] p-7 backdrop-blur-sm transition-colors duration-300 hover:border-gold-500/70 hover:bg-white/[0.06] sm:p-8">
